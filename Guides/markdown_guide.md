...
```markdown
Here is a _piece of text_ in italics.  
...
Wrap the text with \*\* or \_\_:

```markdown
This is a **piece of text** in bold.  
This is another **piece of text** in bold.
```
...
```markdown
This is a **_piece of text_** in bold.  
This is another **_piece of text_** in bold.
```
...
| Col 1    | Col 2    | Col 3    |
| -------- | -------- | -------- |
| _Item 1_ | _Item 2_ | _Item 3_ |
| _Item 4_ | _Item 5_ | _Item 6_ |
```
